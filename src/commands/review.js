...
const { getDebateInfo, openDebateChannels } = require('../lib/voting');
...
module.exports = {
  ...
  async execute(interaction) {
    ...
    if (action === 'approve' && debateInfo) {
      openDebateChannels(interaction.client, resolution, config).catch((err) => console.error('Failed to open debate channels:', err));
